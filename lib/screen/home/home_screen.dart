                                        ...
                                        child: Container(
                                            ...
                                            child: Center(
                                              child: snapshot1.data != null &&
                                                  ...
                                                  ? Text(
                                                  "${snapshot1.data[2].score}")
                                                  : Text(""),
                                            )),
                                        onTap: () {
                                          if (!container2) {
                                            sentimentos(snapshot.data[2].text);
                                            container2 = true;
                                          }
                                        },
                                      ),
                                        ...
                                        child: Container(
                                            ...
                                            child: Center(
                                              child: snapshot1.data != null &&
                                                  ...
                                                  ? Text(
                                                  "${snapshot1.data[3].score}")
                                                  : Text(""),
                                            )),
                                        onTap: () {
                                          if (!container3) {
                                            sentimentos(snapshot.data[3].text);
                                            container3 = true;
                                          }
                                        },
                                      ),
                                        ...
                                        child: Container(
                                            ...
                                            child: Center(
                                              child: snapshot1.data != null &&
                                                  ...
                                                  ? Text(
                                                  "${snapshot1.data[4].score}")
                                                  : Text(""),
                                            )),
                                        onTap: () {
                                          if (!container4) {
                                            sentimentos(snapshot.data[4].text);
                                            container4 = true;
                                          }
                                        },
                                      ),
                                        ...
                                        child: Container(
                                            ...
                                            child: Center(
                                              child: snapshot1.data != null &&
                                                  ...
                                                  ? Text(
                                                  "${snapshot1.data[5].score}")
                                                  : Text(""),
                                            )),
                                        onTap: () {
                                          if (!container5) {
                                            sentimentos(snapshot.data[5].text);
                                            container5 = true;
                                          }
                                        },
                                      ),
                                        ...
                                        child: Container(
                                            ...
                                            child: Center(
                                              child: snapshot1.data != null &&
                                                  ...
                                                  ? Text(
                                                  "${snapshot1.data[6].score}")
                                                  : Text(""),
                                            )),
                                        onTap: () {
                                          if (!container6) {
                                            sentimentos(snapshot.data[6].text);
                                            container6 = true;
                                          }
                                        },
                                      ),
                                        ...
                                        child: Container(
                                            ...
                                            child: Center(
                                              child: snapshot1.data != null &&
                                                  ...
                                                  ? Text(
                                                  "${snapshot1.data[7].score}")
                                                  : Text(""),
                                            )),
                                        onTap: () {
                                          if (!container7) {
                                            sentimentos(snapshot.data[7].text);
                                            container7 = true;
                                          }
                                        },
                                      ),
                                        ...
                                        child: Container(
                                            ...
                                            child: Center(
                                              child: snapshot1.data != null &&
                                                  ...
                                                  ? Text(
                                                  "${snapshot1.data[8].score}")
                                                  : Text(""),
                                            )),
                                        onTap: () {
                                          if (!container8) {
                                            sentimentos(snapshot.data[8].text);
                                            container8 = true;
                                          }
                                        },
                                      ),
                                        ...
                                        child: Container(
                                            ...
                                            child: Center(
                                              child: snapshot1.data != null &&
                                                  ...
                                                  ? Text(
                                                  "${snapshot1.data[9].score}")
                                                  : Text(""),
                                            )),
                                        onTap: () {
                                          if (!container9) {
                                            sentimentos(snapshot.data[9].text);
                                            container9 = true;
                                          }
                                        },
                                      ),
